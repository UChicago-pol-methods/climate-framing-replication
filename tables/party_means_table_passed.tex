...
\end{tabular}
\begin{tablenotes}
\item The sample is respondents that passed both attention checks, $n = $ \num{2127}. Columns represent party identification. Standard errors are reported in parentheses below estimates.
\end{tablenotes}
\end{threeparttable}
\end{table}
